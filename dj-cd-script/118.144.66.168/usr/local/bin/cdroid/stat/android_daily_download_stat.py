...
DOMAIN_CDN_CARRIER = {
                  "g.androidgame-store.com.cn":   {"carrier":CARRIER_WANGSU,"username":"log","password":"logdown123!","channel":[30],"pattern":        re.compile("^(?P<IP>\S*) +\S* +\S* +\[(?P<TIME>\S*) +\S*\] +\S+ +(http://)(?P<URL>g.androidgame-store.com)?(:80)?(/android)?/+new/+(?P<GAME>\w+)/+\d+/+(?P<GAMEID>\d+)/(?P<FILE_NAME>\S+\.(apk|dpk|zip))(\?(f=(?P<CHANNELID>\w*))?)?.* +\S+\" +(?P<STATUS>\d+) +\S* +\"(?P<SOURCE>[^\"]*)\" +\"(?P<UA>[^\"]*)\".*$")},
                   "g3.androidgame-store.com.cn":   {"carrier":CARRIER_WANGSU,"username":"log","password":"logdown123!","channel":[30],"pattern":        re.compile("^(?P<IP>\S*) +\S* +\S* +\[(?P<TIME>\S*) +\S*\] +\S+ +(http://)(?P<URL>g3.androidgame-store.com)?(:80)?(/android)?/+new/+(?P<GAME>\w+)/+\d+/+(?P<GAMEID>\d+)/(?P<FILE_NAME>\S+\.(apk|dpk|zip))(\?(f=(?P<CHANNELID>\w*))?)?.* +\S+\" +(?P<STATUS>\d+) +\S* +\"(?P<SOURCE>[^\"]*)\" +\"(?P<UA>[^\"]*)\".*$")},
