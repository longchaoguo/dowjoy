...
SERVERNODE_ARRAY = {}
DEFAULT_URL="http://res.d.cn/android/new/game/"
DEFAULT_URL_PREFIX="http://res.d.cn/android/"
...
def changeSyncStatus():
    ...
    if msgBody != "" :
        sendmail('webmaster@downjoy.com', MONITOR_MAIL, msgBody, "android 同步文件出错,211.147.5.167_usr_local_bin_new_changeAndroidResGameStatus.py")
...
print "new_changeAndroidResGameStatus.py start at %s"%startTime
try :
...
print "new_changeAndroidResGameStatus.py end at %s"%endTime
