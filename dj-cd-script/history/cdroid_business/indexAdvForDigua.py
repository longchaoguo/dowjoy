...
def getOriginalAdvData():
    sql = "SELECT GROUP_TYPE, GROUP_ID, BACKGROUND_IMAGE, GROUP_ORDER, TITLE, RESOURCE_ID, RESOURCE_TYPE, URL, ID, ORIGINAL_TYPE FROM INDEX_ADV_DIGUA_72 WHERE GROUP_ORDER > 0"
...
def insertResourceInfos(tableName, dealedAdvList):
    ...
    insertsql += "(ID, NAME, EN_NAME, ICON, STARS, OUTLINE, PUBLISH_DATE, RESOURCE_TYPE, DATA_TYPE, CREATED_DATE, HOT_CNT, COMMENTS, CATEGORY_ID, CATEGORY_NAME, PKG_ID, PKG_NAME, PKG_PACKAGE_NAME, PKG_FILE_SIZE, PKG_URL, PKG_URL_SUFFIX, PKG_VERSION_NAME, PKG_VERSION_CODE, PKG_CPU_TYPE_SET, PKG_MIN_SDK, PKG_NEED_GOOGLE_FRAMEWORK, PKG_CREATED_DATE, GROUP_TYPE, GROUP_ID, GROUP_DESCRIPTION, BACKGROUND_IMAGE, GROUP_ORDER, TITLE, URL, GROUP_INNER_ORDER, COMMENT_AVATAR_URL, COMMENT_GOODRAT, COMMENT_CONTENT, COMMENT_USER_ID, COMMENT_USER_NAME, ORIGINAL_TYPE, COMMENT_ID, COMMENT_DEVICE, COMMENT_IP_ADDRESS, COMMENT_PUBLISH_TIME) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
