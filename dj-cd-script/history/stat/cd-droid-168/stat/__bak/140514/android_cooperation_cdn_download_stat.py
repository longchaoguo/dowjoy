...
pattern4 = re.compile("(?P<IP>\S*) \S* \S* \[(?P<TIME>\S+) \S+\] \S+ http://down.androidgame-store.com\/\w+\/\w+\/\w+\/(?P<GAME>\w+)\/\d+\/(?P<RID>\d+)\/(?P<PKG>\S*)\?f=(?P<PARAM>[^&=]*)\S* \S* (?P<STATUS>\d+) \S* \S* \"(?P<UA>[^\"]*)\"")
pattern5 = re.compile("(?P<IP>\S*) \S* \S* \[(?P<TIME>\S+) \S+\] \S+ http://p.androidgame-store.com\/\w+\/(?P<GAME>\w+)\/\d+\/(?P<RID>\d+)\/(?P<PKG>\S*)\?f=(?P<PARAM>[^&=]*)\S* \S* (?P<STATUS>\d+) \S* \S* \"(?P<UA>[^\"]*)\"")
