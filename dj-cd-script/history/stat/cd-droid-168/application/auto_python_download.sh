...
python /usr/local/bin/cdroid/stat/android_download_log_analysis.py
python /usr/local/bin/cdroid/stat/android_download_log_to_daily_stat.py
python /usr/local/bin/cdroid/stat/android_download_daily_monitor_report.py
...
python /usr/local/bin/cdroid/stat/netgame_download_stat.py
python /usr/local/bin/cdroid/stat/cooperation_game_download_stat.py
python /usr/local/bin/cdroid/report/android_paid_game_down_report.py
...
python /usr/local/bin/cdroid/stat/android_daily_download_stat.py
