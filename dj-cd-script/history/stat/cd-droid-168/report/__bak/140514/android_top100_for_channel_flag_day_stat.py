...
mailTo = ['lin.he@downjoy.com', 'christina.gu@downjoy.com', 'chao.nie@downjoy.com','dong.wei@downjoy.com', 'jacky@downjoy.com','chengbao.yang@downjoy.com','leepong@downjoy.com','qicheng.meng@downjoy.com']
...
mailContents = (u"Hi,这是%s日Android下载量各渠道TOP100统计表。若有异常请与晓东联系。谢谢"%(lastDay)).encode("gbk")
###############################
def getGameData():
