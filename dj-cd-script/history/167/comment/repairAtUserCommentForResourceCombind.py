...
mailSubject = u"repairAtUserCommentForResourceCombind.py）".encode("gbk")
...
def main():
    ...
    print combindIds
    for out in db.atUserComment.find({},{"resourceKey":1, "subComments":1, "subs":1}).batch_size(10000):
        if out.has_key("resourceKey"):
            ...
            if resType==1 and combindIds.has_key(resId):
                ...
                db.atUserComment.update({"_id":id}, {"$set":setValue})
